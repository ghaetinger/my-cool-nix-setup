...
/* appearance */
static const int *panel[4] = {0, 0, 0, 0};
static const unsigned int borderpx  = 0;        /* border pixel of windows */
static const unsigned int snap      = 32;       /* snap pixel */
static const int showbar            = 1;        /* 0 means no bar */
static const int topbar             = 1;        /* 0 means bottom bar */
static const unsigned int gappx     = 15;        /* gap pixel between windows */
static const char *fonts[]          = { "Iosevka:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true"};
static const char dmenufont[]       = "Iosevka 10";
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray1, col_drac,  col_drac  },
};
...
static const char dmenumode[] = { "drun" };
static const char *flameshotcmd[] = { "flameshot", "gui", NULL };
static const char *dmenucmd[]     = { "rofi", "-modi", dmenumode, "-show", dmenumode, "-font", dmenufont, "-show-icons", NULL };
static const char *termcmd[]      = { "alacritty", NULL };
static const char *emacs[]        = { "emacsclient", "-c", "-a", "emacs", NULL };
static const char *i3lock[]       = { "i3lock", "-n", "-c", "000000", NULL };
static const char *guvcview[]       = { "guvcview", "--gui=none", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY,                       XK_e,      spawn,          {.v = emacs } },
	{ MODKEY,                       XK_c,      spawn,          {.v = guvcview } },
